...
import {Close as CloseIcon, Info as InfoIcon, Key as KeyIcon,} from '@mui/icons-material';

// Step components
import {ApiKeyDisplayStep, ConfigurationStep, GenerationStep, WelcomeStep,} from './steps';
