...
import {useAudioNotifications, useAuthStatus, useNotifications, useUptime} from '@/hooks'
import type {
                ...
                items: [
                    ...
                    },
                    {
                        ...
                        icon: (
                            <Link sx={{
                                fontSize: 18,
                                color: (connectionId && isConnected) ? '#2d7a32' : 'text.disabled'
                            }}/>
                        ),
                    },
                    {
                        ...
                        icon: (
                            <AccountBox sx={{
                                fontSize: 18,
                                color: (user?.profile?.sub && isConnected) ? '#2d7a32' : 'text.disabled'
                            }}/>
                        ),
                    },
                    {
